...
TRTModule::TRTModule(string pathModel, string pathClasses){
    ...
    inputDataContainers = {PrepareImageTensor<float>(inVideoName, static_cast<int>(imageShape[0]), static_cast<int>(imageShape[1]), optParam, inputTensorBatchSize, inputTensorDataLayout)};
